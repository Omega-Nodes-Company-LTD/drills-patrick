...
export async function saveProject(input: unknown): Promise<ActionResult<{ id: string }>> {
  ...
  const values = {
    ...
    preWalkMinutes: data.preWalkMinutes ?? null,
    postWalkMinutes: data.postWalkMinutes ?? null,
    preQueueMinutes: data.preQueueMinutes ?? null,
    postQueueMinutes: data.postQueueMinutes ?? null,
